...
def KNN_classifier(train_features, train_labels, test_features, num_neighbors):
    ...
    train_features
    knn_classify = KNeighborsClassifier(n_neighbors=num_neighbors)
    knn_classify.fit(train_features, train_labels)
    predicted_categories = knn_classify.predict(test_features)
